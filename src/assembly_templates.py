...
templates = {
    ...
    'X86SyscallStubExtendedJump': AssemblyTemplate(
        ...
        RawBytes(0x89, 0x25, 0x04, 0x40, 0x00, 0x70), # movl %esp,(stub_scratch_1)
        RawBytes(0xFF, 0x05, 0x08, 0x40, 0x00, 0x70), # incl (alt_stack_nesting_level)
        RawBytes(0x83, 0x3c, 0x25, 0x08, 0x40, 0x00, 0x70, 0x01), # cmpl 1,(alt_stack_nesting_level)
        RawBytes(0x75, 0x06),                                     # jne dont_switch
        RawBytes(0x8b, 0x25, 0x00, 0x40, 0x00, 0x70), # movl (syscallbuf_stub_alt_stack),%esp
        # dont_switch:
        RawBytes(0xff, 0x35, 0x04, 0x40, 0x00, 0x70), # pushl (stub_scratch_1)
    ...
    'X64SyscallStubExtendedJump': AssemblyTemplate(
        # This code must match the stubs in syscall_hook.S.
        RawBytes(0x48, 0x89, 0x24, 0x25, 0x08, 0x40, 0x00, 0x70), # movq %rsp,(stub_scratch_1)
        RawBytes(0xFF, 0x04, 0x25, 0x10, 0x40, 0x00, 0x70),       # incl (alt_stack_nesting_level)
        RawBytes(0x83, 0x3c, 0x25, 0x10, 0x40, 0x00, 0x70, 0x01), # cmpl 1,(alt_stack_nesting_level)
        RawBytes(0x75, 0x08),                                     # jne dont_switch
        RawBytes(0x48, 0x8b, 0x24, 0x25, 0x00, 0x40, 0x00, 0x70), # movq (syscallbuf_stub_alt_stack),%rsp
        # dont_switch:
        RawBytes(0xff, 0x34, 0x25, 0x08, 0x40, 0x00, 0x70), # pushq (stub_scratch_1)
