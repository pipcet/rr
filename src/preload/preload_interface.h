...
#define RR_PAGE_LWP_THUNK_ENTRY (RR_PAGE_LWP_THUNK + 2)
#define RR_PAGE_LWP_THUNK_END (RR_PAGE_LWP_THUNK_ENTRY + 12)
#define RR_PAGE_FF_BYTES (RR_PAGE_LWP_THUNK + 16)

#define PRELOAD_THREAD_LOCALS_ADDR (RR_PAGE_ADDR + 4 * PAGE_SIZE)
